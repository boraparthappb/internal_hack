...
public class TransliterateAsync extends AsyncTask<Void, Integer, String> {
    private URL url;
    ...
    public TransliterateAsync(Context context, ArrayList<String> inputStrings, String api_key, String app_id, int domain, String targetLang, String sourceLang, int status, String uuid, LocalizeListener listener) {
...
//            String transliterateUrl = "http://api.revup.reverieinc.com/v2/localization?";
            String transliterateUrl = "http://beta.api.revup.reverieinc.com/v2/transliteration?";
//            String transliterateUrl = "http://beta.api.revup.reverieinc.com/v2/transliteration?target_lang=assamese&source_lang=english";
            ...
            try {
                transliterateUrl += urlAppend.toString();
                Log.e("transliterateUrl", "=" + transliterateUrl);
                url = new URL(transliterateUrl);
        ...
        if (s != null) {
            ...
            try {
                ...
                for (int i = 0; i < len; i++) {
                    ...
                    JSONArray outStringArr = ob.getJSONArray("outString");
                    myMap.put(ob.getString("inString"), outStringArr.getString(0));
//                    for (int j=0;j<outStringArr.length();j++) {
//                        myMap.put(ob.getString("inString"), outStringArr.getString(j));
//                    }
...
//        finalMap.putAll(myMap);
    ...
    private JSONObject getJsonObj(ArrayList<String> inputStrings) {
